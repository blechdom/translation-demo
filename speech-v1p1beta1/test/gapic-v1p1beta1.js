...
describe('SpeechClient', () => {
  describe('recognize', () => {
    it('invokes recognize without error', done => {
      ...
      // Mock response
      const recognizerMode = 'recognizerMode-1968746658';
      const s3Condition = 's3Condition-1840820804';
      const expectedResponse = {
        recognizerMode: recognizerMode,
        s3Condition: s3Condition,
      };
  ...
  describe('demoRecognize', () => {
    it('invokes demoRecognize without error', done => {
      const client = new speechModule.v1p1beta1.SpeechClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
      ...
      // Mock Grpc layer
      client._innerApiCalls.demoRecognize = mockSimpleGrpcMethod(
        request,
        expectedResponse
      );

      client.demoRecognize(request, (err, response) => {
        assert.ifError(err);
        assert.deepStrictEqual(response, expectedResponse);
        done();
      });
    ...
    it('invokes demoRecognize with error', done => {
      const client = new speechModule.v1p1beta1.SpeechClient({
        credentials: {client_email: 'bogus', private_key: 'bogus'},
        projectId: 'bogus',
      });
  ...
  describe('streamingRecognize', () => {
    it('invokes streamingRecognize without error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.streamingRecognize = mockBidiStreamingGrpcMethod(request, expectedResponse);
    ...
    it('invokes streamingRecognize with error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.streamingRecognize = mockBidiStreamingGrpcMethod(request, null, error);
