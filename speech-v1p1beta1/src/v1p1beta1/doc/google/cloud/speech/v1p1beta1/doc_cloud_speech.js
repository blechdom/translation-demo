 ...
 *
 * @property {Object[]} internalExtensions
 *   *Internal* Only a place-holder for proto extensions.
 *
 *   This object should have the same structure as [Any]{@link google.protobuf.Any}
 *
 * @property {boolean} v1beta1Mode
 *   *Internal* Whether to preserve v1beta1 behavior in cases where that differs
 *   from v1 behavior.
 *
 * @property {boolean} useCloudspeechClient
 *   *Internal* Whether to force use of the new cloudspeech client.
 *
 ...
 *   hearings from 2012".
 *
 * @property {number} dataLogsProjectNumberOverride
 *   Project number under which to store logs data.
 *
 *   This field exists only for Alpha AutoML launch to allow DialogFlow to
 *   write logs data under specified client project for proper data Wipeout.
 *   Otherwise, all DialogFlow calls are logged under DialogFlow project and
 *   data won't be erased when end user deletes their project.
 *
 *   This field must be restricted for GOOGLE_INTERNAL and used by internal,
 *   trusted projects.
 *
 ...
 *
 * @property {string} cns
 *   String containing a valid cns path. cns paths should only be used by
 *   internal customers. It is the responsibility of the owner of the path to
 *   make sure that cloud-ml-speech-prod and cloud-ml-speech-frontend can
 *   access the file.
 *
 ...
 *
 * @property {Object} totalBilledTime
 *   Output only. Should be the exact billed audio seconds sent to Chemist.
 *
 *   This object should have the same structure as [Duration]{@link google.protobuf.Duration}
 *
 * @property {string} recognizerMode
 *   Output only. Should be the recognizer mode used in s3 backend. This
 *   field is for google internal usage only.
 *
 * @property {string} s3Condition
 *   Output only. Should be the s3_condition triggered based on request. This
 *   field is for google internal usage only.
 *
 * @property {Object[]} internalExtensions
 *   Output only. Can store any metadata. This field is for google internal
 *   usage only.
 *
 *   This object should have the same structure as [Any]{@link google.protobuf.Any}
 *
 ...
 *
 * @property {Object} totalBilledTime
 *   Output only. The exact billed audio duration sent to Chemist, set only if
 *   this is the last response in the stream."
 *
 *   This object should have the same structure as [Duration]{@link google.protobuf.Duration}
 *
 * @property {string} recognizerMode
 ...
 *   beginning of the audio. This field is internal-only and is used to order
 *   results based on their timestamps.
 *
 *   This object should have the same structure as [Duration]{@link google.protobuf.Duration}
 *
 * @property {string} languageCode
