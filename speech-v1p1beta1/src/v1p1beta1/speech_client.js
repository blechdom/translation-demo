...
class SpeechClient {
  ...
  constructor(opts) {
    ...
    protoFilesRoot = protobuf.loadSync(
      path.join(__dirname, '..', '..', 'protos', 'google/cloud/speech/v1p1beta1/cloud_speech.proto'),
      protoFilesRoot
    );
  ...
  /**
   * Performs synchronous speech recognition using demo speech server.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {Object} request.config
   ...
   *   });
   */
  demoRecognize(request, options, callback) {
    if (options instanceof Function && callback === undefined) {
      callback = options;
      options = {};
    }
    ...
    return this._innerApiCalls.demoRecognize(request, options, callback);
  }
