...
class SpeechLanguageSelect extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  handleSpeechLanguageChange = (event) => {
    this.setState({ speechLanguageCode: event.target.value });
    console.log("speech Language selected is " + event.target.value);
    socket.emit("speechLanguageCode", event.target.value);
  };
    ...
    return (
      <div className={classes.root}>
        <FormControl className={classes.formControl}>
          ...
          }} htmlFor="speech-language">Language</InputLabel>
          <Select
            native
            value={this.state.speechLanguageCode}
            onChange={this.handleSpeechLanguageChange}
            inputProps={{
              name: 'speech_language_code',
              id: 'speech-language-code',
            }}
          >
          <option value="" />
...
SpeechLanguageSelect.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(SpeechLanguageSelect);
