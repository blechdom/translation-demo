...
/**
 * The top-level message sent by the client for the `SynthesizeTacotron2`
 * method.
 *
 * @property {string} name
 *   Required. The name of the voice to be used to synthesize speech.
 *
 * @property {string} inputText
 *   Required. Plain text to be synthesized.
 *
 * @typedef SynthesizeTacotron2Request
 * @memberof google.cloud.texttospeech.v1beta1
 * @see [google.cloud.texttospeech.v1beta1.SynthesizeTacotron2Request definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/texttospeech/v1beta1/cloud_tts.proto}
 */
const SynthesizeTacotron2Request = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};

/**
 * The message returned to the client by the `SynthesizeTacotron2` method.
 *
 * @property {string} audioContent
 *   The audio data bytes encoded as specified in the request, in WAV format.
 *   Note: as with all bytes fields, protobuffers use a pure binary
 *   representation, whereas JSON representations use base64.
 *
 * @typedef SynthesizeTacotron2Response
 * @memberof google.cloud.texttospeech.v1beta1
 * @see [google.cloud.texttospeech.v1beta1.SynthesizeTacotron2Response definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/texttospeech/v1beta1/cloud_tts.proto}
 */
const SynthesizeTacotron2Response = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};
 ...
 *   The list of voices.
 *
 *   This object should have the same structure as [Voice]{@link google.cloud.texttospeech.v1beta1.Voice}
 *
 * @typedef ListVoicesResponse
 * @memberof google.cloud.texttospeech.v1beta1
 ...
 *
 *   The number should be among the values of [SsmlVoiceGender]{@link google.cloud.texttospeech.v1beta1.SsmlVoiceGender}
 *
 ...
 *
 *   The number should be among the values of [AudioEncoding]{@link google.cloud.texttospeech.v1beta1.AudioEncoding}
 *
