...
class TextToSpeechClient {
   ...
   * @example
   *
   * const texttospeech = require('texttospeech.v1beta1');
   *
   ...
   *
   * const languageCode = '';
   * client.listVoices({languageCode: languageCode})
   *   .then(responses => {
  ...
  /**
   * Synthesizes speech synchronously using Tacotron2 model.
   *
   * @param {Object} request
   *   The request object that will be sent.
   * @param {string} request.name
   *   Required. The name of the voice to be used to synthesize speech.
   * @param {string} request.inputText
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [SynthesizeTacotron2Response]{@link google.cloud.texttospeech.v1beta1.SynthesizeTacotron2Response}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is an object representing [SynthesizeTacotron2Response]{@link google.cloud.texttospeech.v1beta1.SynthesizeTacotron2Response}.
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   *
   * @example
   *
   ...
   *   inputText: inputText,
   * };
   * client.synthesizeTacotron2(request)
   *   .then(responses => {
   *     const response = responses[0];
   *     // doThingsWith(response)
   *   })
   ...
   *   });
   */
  synthesizeTacotron2(request, options, callback) {
    if (options instanceof Function && callback === undefined) {
      callback = options;
      options = {};
    }
    ...
    return this._innerApiCalls.synthesizeTacotron2(request, options, callback);
  }
}
